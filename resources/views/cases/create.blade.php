        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <!-- Name -->
                    <div>
                        <x-label for="name" :value="__('Select Beneficiary')" />
                        <select class="select2 block mt-1 mb-1 w-full"></select>
                    </div>
                    ...
                    <div>
                        ...
                        <x-input id="address" class="block mt-1 mb-1 w-full" type="text" name="address" required
                            :value="old('address')" autofocus placeholder="Enter Address" />
                    </div>
                    ...
                    <div class="flex justify-between w-full">
                        <div class="flex items-center justify-start mt-4 ">
                            <a href="{{ route('user.index') }}" class="bg-black text-white p-2 rounded"> <i
